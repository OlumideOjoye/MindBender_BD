...
# Remove empty configuration tags in the hdfs-site.xml 
sed -i "s@<configuration>@$ @g" hdfs-site.xml
sed -i "s@</configuration>@$ @g" hdfs-site.xml

# update hdfs-site.xml config settings
echo '
<configuration>
  <property>
...
# Remove empty configuration tags in yarn-site.xml
sed -i "s@<configuration>@$ @g" yarn-site.xml
sed -i "s@</configuration>@$ @g" yarn-site.xml

# update yarn-site.xml config settings
echo '
<configuration>
  <property>
...
# Make a copy of mapred-site.xml.template:
cp mapred-site.xml.template mapred-site.xml

# Remove empty configuration tags in mapred-site.xml
sed -i "s@<configuration>@$ @g" mapred-site.xml
sed -i "s@</configuration>@$ @g" mapred-site.xml

# update mapred-site.xml config settings
echo '
<configuration>
  <property>
